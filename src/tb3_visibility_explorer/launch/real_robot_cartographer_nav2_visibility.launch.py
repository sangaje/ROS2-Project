...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('explorer_delay_sec', default_value='16.0'),
        ...
        # false means: use Nav2 ComputePathToPose if it is ready; otherwise fall back to internal A*.
        DeclareLaunchArgument('prefer_internal_grid_planner', default_value='false'),
