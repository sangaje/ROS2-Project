...
def generate_launch_description():
    ...
    pkg_share = get_package_share_directory('tb3_visibility_explorer')
    default_slam_params = os.path.join(pkg_share, 'config', 'real_robot_slam_toolbox.yaml')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('explorer_delay_sec', default_value='35.0'),
            ...
            actions=[
                Node(
                    ...
                    parameters=[{
                        ...
                        'planning_period': 0.40,
                        'map_stable_time': 0.35,
                        'max_plan_trials': 20,
                        ...
                        'coverage_publish_period': 0.8,
                        'enable_slam_warmup': True,
                        'slam_warmup_min_duration': 10.0,
                        'slam_warmup_max_duration': 22.0,
                        'slam_warmup_min_known_cells': 500,
                        'slam_warmup_min_free_cells': 220,
                        'slam_warmup_angular_speed': 0.18,
                        ...
                        'allow_probe_during_map_stabilizing': False,
                        ...
                        'direct_follow_max_linear_speed': 0.18,
                        'direct_follow_min_linear_speed': 0.035,
                        'direct_follow_max_angular_speed': 1.10,
