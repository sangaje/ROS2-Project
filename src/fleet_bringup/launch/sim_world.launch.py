...
def generate_launch_description():
    turtlebot3_gz_share = get_package_share_directory('turtlebot3_gazebo')
    ...
    default_world = os.path.join(turtlebot3_gz_share, 'worlds', 'turtlebot3_world.world')
    leader_sdf    = os.path.join(turtlebot3_gz_share, 'models', 'turtlebot3_burger', 'model.sdf')
    leader_bridge_yaml = os.path.join(turtlebot3_gz_share, 'params', 'turtlebot3_burger_bridge.yaml')
    leader_urdf   = os.path.join(turtlebot3_gz_share, 'urdf', 'turtlebot3_burger.urdf')
    ...
    return LaunchDescription([
        ...
        *dds_launch_environment(domain_id),
        AppendEnvironmentVariable('GZ_SIM_RESOURCE_PATH',
                                  os.path.join(turtlebot3_gz_share, 'models')),
        gz_server,
        gz_client,
        leader_rsp,
        follower_rsp,
