...
patterns=(
  'ros2 launch fleet_bringup leader.launch.py'
  'ros2 launch fleet_bringup follower.launch.py'
  'ros2 launch fleet_bringup rviz.launch.py'
  'ros2 launch fleet_bringup robot.launch.py'
  'ros2 launch fleet_bringup sim_world.launch.py'
  ...
  '/nav2_amcl/amcl'
  '/fleet_bringup/fleet_follower'
  '/fleet_bringup/fleet_path_coordinator'
  '/fleet_bringup/tf_pose_publisher'
  '/fleet_bringup/pose_to_nav2'
  '/fleet_bringup/pose_to_tf'
  '/fleet_bringup/fleet_debug_marker'
  '/fleet_bringup/sim_burger_scan_relay'
  '/fleet_bringup/scan_frame_relay'
  'lidar_autostart.py'
  'real_burger_scan_frame_relay'
  '/fleet_bringup/sim_burger_tf_relay'
  '/fleet_bringup/map_relay'
...
rm -rf /tmp/sim_domain_bridge \
       /tmp/fleet_domain_bridge
