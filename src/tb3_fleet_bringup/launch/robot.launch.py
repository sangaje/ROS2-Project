...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('usb_port',   default_value=EnvironmentVariable('USB_PORT',   default_value='/dev/ttyACM0')),
        DeclareLaunchArgument('lidar_port', default_value=EnvironmentVariable('LIDAR_PORT', default_value='/dev/ttyUSB0')),
