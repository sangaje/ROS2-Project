...
class AStarCmdVelFollower(Node):
    """V51 robust A* + direct TwistStamped controller.
    ...
    Important V51 change vs V48/V49:
    ...
    def __init__(self):
        ...
        self.get_logger().info(
            'V53_ASTAR_CMD_VEL_CONTROLLER_READY | TwistStamped direct controller | '
    ...
    def control_loop(self):
        ...
        if self.last_log_time is None or log_dt is None or log_dt >= self.log_period_sec:
            ...
            self.get_logger().info(
                f'V53_ASTAR_CMD | robot={self.robot_name} mode={self.target_mode}/{self.leader_goal_mode} '
