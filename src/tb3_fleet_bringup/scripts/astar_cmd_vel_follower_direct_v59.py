...
class AStarCmdVelFollower(Node):
    """V59 conservative A* + exploration/direct fallback TwistStamped controller.
    ...
    def __init__(self):
        ...
        self.get_logger().info(
            'V59_ASTAR_CMD_VEL_CONTROLLER_READY | TwistStamped direct controller | '
    ...
    def control_loop(self):
        ...
        if self.last_log_time is None or log_dt is None or log_dt >= self.log_period_sec:
            ...
            self.get_logger().info(
                f'V59_ASTAR_CMD | robot={self.robot_name} mode={self.target_mode}/{self.leader_goal_mode} '
