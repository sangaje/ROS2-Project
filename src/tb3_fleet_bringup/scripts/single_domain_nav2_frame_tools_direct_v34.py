...
class SingleDomainNav2FrameTools(Node):
    ...
    def __init__(self) -> None:
        ...
        self.get_logger().info(
            'V34_REAL_NAV2_FRAME_TOOLS_READY | '
    ...
    def _initial_pose_tick(self) -> None:
        ...
        self.get_logger().info(
            f'V34_SIMTIME_INITIALPOSE_PUB | robot={self.robot_name} count={self.initial_count}/{self.initial_pose_repeat_count} stamp={msg.header.stamp.sec}.{msg.header.stamp.nanosec:09d} '
