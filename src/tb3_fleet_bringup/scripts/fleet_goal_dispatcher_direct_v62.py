...
class FleetGoalDispatcher(Node):
    ...
    Input: one RViz PoseStamped group goal (/fleet_goal_pose).
    ...
    def __init__(self) -> None:
        ...
        self.republish_period_sec = float(_safe_declare(self, 'republish_period_sec', 0.20))
        ...
        self.get_logger().info(
            'V62_FLEET_GOAL_DISPATCHER_READY | '
            f'in={self.input_goal_topic} waffle_out={self.waffle_goal_topic} burger_out={self.burger_goal_topic} '
    ...
    def _on_fleet_goal(self, msg: PoseStamped) -> None:
        ...
        self.get_logger().info(
            f'V62_FLEET_GOAL_DISPATCH | n={self.goal_count} clicked=({x:.3f},{y:.3f}) '
