...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('start_flask_server', default_value='false'),
        DeclareLaunchArgument('start_robot_bringup', default_value='false'),
        DeclareLaunchArgument('start_camera', default_value='false'),
        DeclareLaunchArgument('start_image_sender', default_value='false'),
        ...
        DeclareLaunchArgument('start_pose_publisher', default_value='false'),
        ...
        DeclareLaunchArgument('cartographer_configuration_directory', default_value=PathJoinSubstitution([
            FindPackageShare('tb3_bayesian_risk_map'),
            'config',
        ])),
