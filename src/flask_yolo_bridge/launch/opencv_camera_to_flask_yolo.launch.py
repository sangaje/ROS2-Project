...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('active_max_upload_mbps', default_value='2.5'),
        DeclareLaunchArgument('standby_max_upload_mbps', default_value='0.8'),
        DeclareLaunchArgument('http_worker_count', default_value='1'),
        DeclareLaunchArgument('jpeg_quality', default_value='65'),
        DeclareLaunchArgument('letterbox_color', default_value='0'),
        ...
        DeclareLaunchArgument('enable_role_gating', default_value='true'),
        ...
        DeclareLaunchArgument('active_scout_id_topic', default_value='/failover/active_scout_id'),
        ...
        Node(
            ...
            parameters=[{
                ...
                'active_max_upload_mbps': LaunchConfiguration('active_max_upload_mbps'),
                'standby_max_upload_mbps': LaunchConfiguration('standby_max_upload_mbps'),
                'http_worker_count': LaunchConfiguration('http_worker_count'),
                'jpeg_quality': LaunchConfiguration('jpeg_quality'),
                'letterbox_color': LaunchConfiguration('letterbox_color'),
                ...
                'standby_roles': LaunchConfiguration('standby_roles'),
