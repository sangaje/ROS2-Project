...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('send_height', default_value='360'),
        ...
        DeclareLaunchArgument('max_rate_hz', default_value='8.0'),
        DeclareLaunchArgument('active_max_rate_hz', default_value='8.0'),
        DeclareLaunchArgument('standby_max_rate_hz', default_value='1.0'),
        DeclareLaunchArgument('active_max_upload_mbps', default_value='3.0'),
        DeclareLaunchArgument('standby_max_upload_mbps', default_value='0.5'),
        DeclareLaunchArgument('http_worker_count', default_value='1'),
        DeclareLaunchArgument('jpeg_quality', default_value='52'),
