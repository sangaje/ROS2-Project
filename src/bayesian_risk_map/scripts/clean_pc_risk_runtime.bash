...
patterns=(
  '/opt/ros/jazzy/bin/[r]os2 launch fleet_bringup'
  '/opt/ros/jazzy/bin/[r]os2 launch bayesian_risk_map'
  '/home/seil/Desktop/ROS2-Project/install/[f]leet_bringup/'
  '[g]z sim'
...
rm -rf /tmp/central_risk_domain_bridge
