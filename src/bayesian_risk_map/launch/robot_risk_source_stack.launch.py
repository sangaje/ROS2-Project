...
def generate_launch_description():
    ...
    default_turtlebot3_param_dir = PathJoinSubstitution([
        FindPackageShare('bayesian_risk_map'),
        'config',
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('tb3_param_dir', default_value=default_turtlebot3_param_dir),
        ...
        DeclareLaunchArgument('send_width', default_value='640'),
        DeclareLaunchArgument('send_height', default_value='480'),
        DeclareLaunchArgument('camera_fps', default_value='5.0'),
        DeclareLaunchArgument('camera_fourcc', default_value='MJPG'),
        DeclareLaunchArgument('jpeg_quality', default_value='65'),
        DeclareLaunchArgument('yolo_max_rate_hz', default_value='5.0'),
        DeclareLaunchArgument('http_worker_count', default_value='1'),
        ...
        DeclareLaunchArgument('http_read_timeout_sec', default_value='1.2'),
