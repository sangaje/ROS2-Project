...
def generate_launch_description():
    ...
    def make_stack(context):
        ...
        launch_args = {
            ...
            # FOLLOWER keeps the external RL worker in role-gated standby so
            # it can resume scouting immediately after failover promotes it
            # to ACTIVE_SCOUT. It is not motion-active while role=FOLLOWER.
