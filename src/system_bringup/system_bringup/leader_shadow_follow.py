...
class LeaderShadowFollow(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter('leader_shadow_max_linear_vel', 0.22)
        self.declare_parameter('leader_shadow_catchup_max_linear_vel', 0.28)
        self.declare_parameter('leader_shadow_max_angular_vel', 0.65)
        self.declare_parameter('leader_restore_max_linear_vel', 0.28)
        self.declare_parameter('leader_restore_max_angular_vel', 0.70)
        ...
        self.declare_parameter('leader_shadow_cmd_max_linear_vel', 0.22)
        self.declare_parameter('leader_shadow_cmd_max_angular_vel', 0.80)
