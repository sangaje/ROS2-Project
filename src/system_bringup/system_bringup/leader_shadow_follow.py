...
class LeaderShadowFollow(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter('leader_shadow_max_linear_vel', 0.20)
        self.declare_parameter('leader_shadow_catchup_max_linear_vel', 0.20)
        self.declare_parameter('leader_shadow_max_angular_vel', 0.80)
        self.declare_parameter('leader_restore_max_linear_vel', 0.20)
        self.declare_parameter('leader_restore_max_angular_vel', 0.80)
        ...
        self.declare_parameter('leader_shadow_cmd_max_linear_vel', 0.20)
