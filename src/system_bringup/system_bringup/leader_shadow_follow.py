...
class LeaderShadowFollow(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter('leader_shadow_max_linear_vel', 0.24)
        self.declare_parameter('leader_shadow_catchup_max_linear_vel', 0.32)
        self.declare_parameter('leader_shadow_max_angular_vel', 0.55)
        self.declare_parameter('leader_restore_max_linear_vel', 0.34)
        self.declare_parameter('leader_restore_max_angular_vel', 0.65)
