...
class LeaderShadowFollow(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter('leader_shadow_max_linear_vel', 0.30)
        self.declare_parameter('leader_shadow_catchup_max_linear_vel', 0.38)
        self.declare_parameter('leader_shadow_max_angular_vel', 0.68)
        self.declare_parameter('leader_restore_max_linear_vel', 0.40)
        self.declare_parameter('leader_restore_max_angular_vel', 0.75)
