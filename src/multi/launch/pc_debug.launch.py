...
def generate_launch_description():
    pkg_multi = get_package_share_directory('multi')
    pkg_turtlebot3_gazebo = get_package_share_directory('turtlebot3_gazebo')
    pkg_ros_gz_sim = get_package_share_directory('ros_gz_sim')

    world = os.path.join(pkg_multi, 'worlds', 'multi_world.world')
    map_yaml = os.path.join(pkg_multi, 'maps', 'turtlemap.yaml')
    rviz_config = os.path.join(pkg_multi, 'rviz', 'multi_gz.rviz')
