...
class RegionNav2Goal(Node):
    ...
    def __init__(self) -> None:
        ...
        self.declare_parameter('marker_topic', '/multi/region_markers')
        self.declare_parameter('region_centers_topic', '/multi/region_centers')
        self.declare_parameter('selected_region_topic', '/multi/selected_region')
    ...
    def publish_region_outputs(
        ...
        for region in regions:
            ...
            outline.ns = 'multi_region_outlines'
            ...
            center.ns = 'multi_region_centers'
