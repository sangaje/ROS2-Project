"""Shared launch helpers for multi."""
...
def make_auto_patrol_node(map_use_sim_time, auto_patrol, rescue_offset_m) -> Node:
    params = {
        ...
        'scout_robot': 'burger1',
        'failover_successor_robot': 'waffle1',
        'scout_liveness_required_sources': ['map_pose', 'odom'],
        'scout_signal_timeout_sec': 2.5,
        'scout_map_pose_timeout_sec': 3.5,
        'scout_odom_timeout_sec': 3.5,
        'scout_down_grace_sec': 2.0,
        'last_scout_pose_max_age_sec': 8.0,
        'failover_standoff_m': 0.45,
        'max_recovery_goal_retries': 3,
        'recovery_goal_retry_period_sec': 1.5,
        'recovery_goal_timeout_sec': 45.0,
        'map_topic': '/map',
...
def make_region_nav2_node(
    ...
    return Node(
        ...
        parameters=[{
            ...
            'marker_topic': '/multi/region_markers',
            'region_centers_topic': '/multi/region_centers',
            'selected_region_topic': '/multi/selected_region',
        }],
        condition=condition,
        output='screen',
    )
...
def _bridge_topics_yaml(
    ...
    robot_to_base = [
        ...
        ('/multi/robot_failure_report', 'std_msgs/msg/String'),
        ('/multi/region_markers', 'visualization_msgs/msg/MarkerArray'),
        ('/multi/region_centers', 'geometry_msgs/msg/PoseArray'),
        ('/multi/selected_region', 'geometry_msgs/msg/PointStamped'),
    ]
    if bridge_map:
    ...
    bidirectional = [
        ('/multi/fail_robot', 'std_msgs/msg/String'),
        ('/multi/recover_robot', 'std_msgs/msg/String'),
    ]

    lines = [
        f'name: multi_{ns}_domain_bridge',
...
def make_dynamic_domain_bridge(
    ...
    def launch_setup(context, *args, **kwargs):
        ...
        fd, path = tempfile.mkstemp(
            prefix=f'multi_{ns.strip().strip("/") or "robot"}_',
