        ...
        TimerAction(
            ...
            actions=[
                ...
                'region_dense_fill_neighbor_min': 1,
                        ...
                        'fallback_to_all_free_when_robot_off_map': False,
                        'robot_free_snap_radius_m': 0.35,
                ...
                'watershed_separator_width_cells': 1,
                        ...
                        'persist_region_ids': True,
                        'region_match_overlap_ratio_min': 0.08,
                        'region_reacquire_max_distance': 1.25,
                        ...
                        'lock_stable_rooms': True,
                        'lock_stable_room_pose': True,
                        'lock_provisional_room_candidates': True,
                        'locked_room_min_stable_count': 6,
                        'locked_room_min_area_m2': 0.25,
                        'locked_room_min_clearance_m': 0.30,
                        'locked_room_claim_radius_m': 0.90,
                        'lock_start_room_as_r1': True,
                        'start_room_id': 1,
                        'start_room_claim_radius_m': 1.25,
                        'start_room_pose_from_robot': True,
                        'publish_locked_room_markers': True,

                        # Visualization.
                        'region_map_id_only': True,
                        'publish_gvd_markers': False,
                        'publish_region_text': True,
                'publish_unlocked_region_text': False,
                'region_text_id_only': True,
                        'publish_latent_frontiers': True,
                'publish_gateway_markers': True,
                'publish_region_outlines': False,
                'region_marker_alpha': 0.84,
                'region_outline_width_m': 0.035,
